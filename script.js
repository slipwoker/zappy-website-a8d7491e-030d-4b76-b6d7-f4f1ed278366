document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function validateField(input) {
            ...
            const fieldName = input.getAttribute('data-name') || input.name || input.placeholder || 'This field';
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                const successMessage = contactForm.querySelector('.form-success') || document.createElement('div');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'a8d7491e-030d-4b76-b6d7-f4f1ed278366',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'a8d7491e-030d-4b76-b6d7-f4f1ed278366';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'a8d7491e-030d-4b76-b6d7-f4f1ed278366';
